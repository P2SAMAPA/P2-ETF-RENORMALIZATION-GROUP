...
OUTPUT_REPO = "P2SAMAPA/p2-etf-renormalization-group-results"
...
# RG parameters
BLOCK_SIZES = [2, 4, 8, 16, 32]    # coarse-graining block sizes
COUPLING_DIM = 4                    # [mean, volatility, skewness, kurtosis]
TOP_N = 3
